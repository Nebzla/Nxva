	...
	data: new SlashCommandBuilder()
		...
		.addStringOption((option) => {
			return option
				.setName("reason")
				.setDescription(
					"The reason for kicking them, defaults to standard in settings",
				);
		}),
				...
				guildTarget
					...
					.catch(async () => {
						return interaction.editReply({
							content:
								"I was unable to kick the user, sorry. Please check I have the necessary permissions to do so ",
							embeds: [],
							components: [],
						});
					});
