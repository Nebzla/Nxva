// Deploys All Slash Commands Globally;
...
(async () => {
    try {
        console.log(`Initialising Refreshing of ${commands.length} application (/) commands`);
        ...
        console.log(`Sucessfully (re)loaded ${data.length} application commands`);
